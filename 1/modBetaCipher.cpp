...
void modBetaCipher::set_key(std::wstring & ws_key)
{
	pillar = getValidKey(ws_key);
}
void modBetaCipher::set_tableform(const std::wstring& open_text)
{
...
std::wstring modBetaCipher::encrypt( std::wstring& open_text)
{
...
inline std::wstring modBetaCipher::getValidOpenText(const std::wstring & ws_open_text)
{
	std::wstring tmp;
...
inline std::wstring modBetaCipher::getValidCipherText(const std::wstring & ws_cipher_text)
{
